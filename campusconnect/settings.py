...
# Gets secret key from environment
...
ALLOWED_HOSTS = ['.gitpod.io', '.herokuapp.com','.ui.dev']
...
# Uses local db.sqlite3 file as development database if Debug = True
...
# Sets it so project does not require email verification for user sign up
...
# Styles Django feedback message pop up with bootstrap classes
MESSAGE_TAGS = {
